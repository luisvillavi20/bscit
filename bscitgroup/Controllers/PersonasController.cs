...
namespace bscitgroup.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DNI,Nombre,Apellido,Celular,Telefono,Pais,Ciudad,Profesion,Institucion,Correo")] Persona persona)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DNI,Nombre,Apellido,Celular,Telefono,Pais,Ciudad,Profesion,Institucion,Correo")] Persona persona)
        {
            if (id != persona.DNI)
            {
                return NotFound();
